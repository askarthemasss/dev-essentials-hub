...
export const tools: Tool[] = [
  ...
  // Advanced Tools — NEW
  { id: "color-contrast", name: "Color Contrast Checker", description: "Check WCAG color contrast ratios", category: "CSS Tools", icon: Contrast },
  { id: "json-schema", name: "JSON Schema Generator", description: "Generate JSON Schema from JSON data", category: "Generators", icon: Braces },
  { id: "jwt-generator", name: "JWT Generator", description: "Create and sign JWT tokens", category: "Security", icon: Lock },
  { id: "gitignore-gen", name: ".gitignore Generator", description: "Generate .gitignore for any stack", category: "Generators", icon: FileX },
  { id: "md-table", name: "Markdown Table Generator", description: "Create markdown tables visually", category: "Generators", icon: StretchHorizontal },
  { id: "js-minifier", name: "JavaScript Minifier", description: "Minify JavaScript code", category: "Formatters", icon: Scissors },
  { id: "html-minifier", name: "HTML Minifier", description: "Minify HTML markup", category: "Formatters", icon: Minimize2 },
  { id: "json-diff", name: "JSON Diff", description: "Compare two JSON objects visually", category: "Converters", icon: GitCompare },
  { id: "timestamp-diff", name: "Timestamp Diff", description: "Calculate difference between two dates", category: "Math/Calc", icon: TimerReset },
  { id: "url-parser", name: "URL Parser", description: "Parse and inspect URL components", category: "Web Tools", icon: LinkIcon },
  { id: "css-clip-path", name: "CSS Clip Path Generator", description: "Generate CSS clip-path shapes", category: "CSS Tools", icon: Hexagon },
  { id: "svg-path-viewer", name: "SVG Path Viewer", description: "Visualize SVG path data", category: "Image/Media", icon: PenTool },
  { id: "hex-dump", name: "Hex Dump Viewer", description: "View text as hex dump output", category: "Encoders/Decoders", icon: Binary },
  { id: "yaml-validator", name: "YAML Validator", description: "Validate YAML syntax with error details", category: "Formatters", icon: FileText },
  { id: "regex-explainer", name: "Regex Explainer", description: "Explain regex patterns in plain English", category: "Miscellaneous", icon: Bug },
  { id: "base58", name: "Base58 Encode/Decode", description: "Encode or decode Base58 strings (Bitcoin)", category: "Encoders/Decoders", icon: Binary },
  { id: "docker-compose", name: "Docker Compose Generator", description: "Generate docker-compose.yml files", category: "Generators", icon: Container },
